...
if coalescentType == 'xi_beta':
    for i in range(trials):
        Pi_2.append(lc.simulateLambdaBeta_FourWay(n,theta/2.,T_max,beta))
elif coalescentType == 'lambda_beta':
    for i in range(trials):
        Pi_2.append(lc.simulateLambdaBeta(n,theta/2.,T_max,beta))
...
###Test if lambda-beta is similar to kingman when alpha ~2
#n = 10
#eps = 0.001
#theta = 2.0
#alpha = 2.0 - eps
